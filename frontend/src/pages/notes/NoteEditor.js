...
import { ArrowLeft, Save, X, Pin, Bold, Italic, Underline, AlignLeft, AlignCenter, AlignRight, AlignJustify, Type, Minus, Hash, List, ListOrdered, Link, Quote, Code, Image, FileText, LogOut } from "lucide-react";
  ...
  useEffect(() => {
    if (noteId) {
      const mockNote = {
        ...
        description: '<p>This is a sample note description with <strong>rich text</strong> capabilities.</p>',
        category: 'work',
        tags: ['sample', 'important'],
        isPinned: false
      };
      setNoteData(mockNote);
      setEditorContent(mockNote.description);
    }
  }, [noteId]);
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg p-6">
            ...
            <div className="mb-6">
              ...
              <div
                ...
                className="min-h-80 w-full px-4 py-4 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-white transition duration-150 ease-in-out"
            ...
            <div className="mb-6">
              <div className="flex items-center">
                ...
                <div className="ml-3 text-sm">
                  ...
                  <p className="text-gray-500">Pinned notes appear at the top of your list</p>
                </div>
              </div>
            </div>
